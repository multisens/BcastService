...
class usp2 implements ServiceInterface {
  base_rul!: string;
  router: Router;
  sid: string;
  ...
  constructor() {
    ...
    this.sid = process.env.USP2_SID || `urn:tv30:service:${cuid.slug()}`;
  }
  ...
  bam(): bam {
    return {
      ...
      initialMediaURLs: [`http://${this.base_rul}/live/hls/usp2.m3u8`],
    };
  }
